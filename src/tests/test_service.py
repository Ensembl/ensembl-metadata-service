...
class TestClass:
    ...
    def test_karyotype_information(self):
        output = json_format.MessageToJson(
            service.get_karyotype_information(
                self.engine, "3c4cec7f-fb69-11eb-8dac-005056b32883"
            )
        )
        expected_output = {}
        assert json.loads(output) == expected_output
    ...
    def test_assembly_information(self):
        output = json_format.MessageToJson(
            service.get_assembly_information(self.engine, "1")
        )
        expected_output = {
    ...
    def test_get_genomes_from_assembly_accession_iterator(self):
        output = [
            json.loads(json_format.MessageToJson(response))
            for response in service.get_genomes_from_assembly_accession_iterator(
                self.engine, "GCA_000005845.2"
            )
        ]
        expected_output = [
            {
                ...
                "organism": {
                    "displayName": "Escherichia coli str. K-12 substr. MG1655 str. "
                    "K12 (GCA_000005845)",
    ...
    def test_sub_species_info(self):
        output = json_format.MessageToJson(
            service.get_sub_species_info(self.engine, "1")
        )
        expected_output = {
            "organismId": "1",
        ...
        output2 = json_format.MessageToJson(
            service.get_grouping_info(self.engine, "51")
        )
        expected_output2 = {}
    ...
    def test_get_top_level_statistics(self):
        output = json_format.MessageToJson(
            service.get_top_level_statistics(self.engine, "4")
        )
    ...
    def test_get_top_level_statistics_by_uuid(self):
        output = json_format.MessageToJson(
            service.get_top_level_statistics_by_uuid(
                self.engine, "a73357ab-93e7-11ec-a39d-005056b38ce3"
            )
        )
        output = json.loads(output)
        print(output)
    ...
    def test_get_datasets_list_by_uuid(self):
        output = json_format.MessageToJson(
            service.get_datasets_list_by_uuid(
                self.engine, "a73356e1-93e7-11ec-a39d-005056b38ce3"
            )
        )
    ...
    def test_get_datasets_list_by_uuid_no_results(self):
        output = json_format.MessageToJson(
            service.get_datasets_list_by_uuid(
                self.engine, "some-random-uuid-f00-b4r", 103.0
            )
        )
        output = json.loads(output)
        expected_output = {}
    ...
    def test_get_dataset_by_genome_id(self):
        output = json_format.MessageToJson(
            service.get_dataset_by_genome_id(
                self.engine, "a73356e1-93e7-11ec-a39d-005056b38ce3", "assembly"
            )
        )
        output = json.loads(output)
        assert output == {
    ...
    def test_get_dataset_by_genome_id_no_results(self):
        output = json_format.MessageToJson(
            service.get_dataset_by_genome_id(
                self.engine, "a7335667-93e7-11ec-a39d-005056b38ce3", "blah blah blah"
            )
        )
        output = json.loads(output)
        assert output == {}
    ...
    def test_get_genome_by_uuid(self):
        output = json_format.MessageToJson(
            service.get_genome_by_uuid(
                self.engine, "a7335667-93e7-11ec-a39d-005056b38ce3", 110.0
            )
        )
        expected_output = {
            "assembly": {
    ...
    def test_genome_by_uuid_release_version_unspecified(self):
        output = json_format.MessageToJson(
            service.get_genome_by_uuid(
                self.engine, "a733574a-93e7-11ec-a39d-005056b38ce3", 0.0
            )
        )
        expected_output = {
            "assembly": {
    ...
    def test_get_genomes_by_keyword(self):
        output = [
            json.loads(json_format.MessageToJson(response))
            for response in service.get_genomes_by_keyword_iterator(
                self.engine, "Human", 110.0
            )
        ]
        expected_output = [
            {
    ...
    def test_get_genomes_by_keyword_no_matches(self):
        output = list(
            service.get_genomes_by_keyword_iterator(self.engine, "bigfoot", 1)
        )
        assert output == []
