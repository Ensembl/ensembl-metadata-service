...
from ensembl.production.metadata import (
...
class EnsemblMetadata(object):
    ...
    @staticmethod
    def GetGenomesByAssemblyAccessionID(
        request,
        target,
        options=(),
        channel_credentials=None,
    ...
    @staticmethod
    def GetTopLevelStatisticsByUUID(
        request,
        target,
        options=(),
        channel_credentials=None,
